function [transStatb,transStatw, elapsedTimes] = WS_transpositions(lossMtx, ...
    nGroup1, nGroup2, nTrans, permNo)
...
%
% Songdechakraiwut, T. Chung, M.K. 2020 Topological learning for brain networks, arXiv: 2012.00675.
%
% INPUT
...
transStatb = zeros(1, nTrans);
transStatw = zeros(1, nTrans);
...
for t = 1:round(nTrans/permNo)
    ...
    transStatb(startInd) = between/denombetween; 
    transStatw(startInd) = within/denomwithin;
    ...
    for n = startInd + 1:startInd + permNo - 1
        ...
        % saving the ratio statistics
        transStatb(n) = prevBetween/denombetween; 
        transStatw(n) = prevWithin/denomwithin;
